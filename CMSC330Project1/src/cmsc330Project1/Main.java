 ...
 * Description: The main method of the whole program is in this class
 * It allows the name of the scene definition file to be input on the command line or selected using the file chooser dialog window.
